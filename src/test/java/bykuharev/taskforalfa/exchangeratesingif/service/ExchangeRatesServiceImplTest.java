...
import bykuharev.taskforalfa.exchangeratesingif.client.OpenExchangeRatesFeignClient;
...
@SpringBootTest
@ComponentScan("bykuharev.taskforalfa")
public class ExchangeRatesServiceImplTest {
    ...
    @MockBean
    private OpenExchangeRatesFeignClient openExchangeRatesClient;
    ...
    public void whenPositiveChanges() {
        ...
        int result = exchangeRatesService.getKeyFromTag("T3");
    ...
    public void whenNegativeChanges() {
        ...
        Mockito.when(openExchangeRatesClient.getHistoricalRates(anyString(), anyString()))
                .thenReturn(this.prevRates);
        int result = exchangeRatesService.getKeyFromTag("T2");
        assertEquals(-1, result);
    }
    ...
    public void whenZeroChanges() {
        ...
        Mockito.when(openExchangeRatesClient.getHistoricalRates(anyString(), anyString()))
                .thenReturn(this.prevRates);
        int result = exchangeRatesService.getKeyFromTag("T1");
    ...
    public void whenGotNullOnInput() {
        ...
        Mockito.when(openExchangeRatesClient.getHistoricalRates(anyString(), anyString()))
                .thenReturn(this.prevRates);
        int result = exchangeRatesService.getKeyFromTag(null);
    ...
    public void whenGotUnExistCharCode() {
        ...
        Mockito.when(openExchangeRatesClient.getHistoricalRates(anyString(), anyString()))
                .thenReturn(this.prevRates);
        int result = exchangeRatesService.getKeyFromTag("UNEXISTED");
        assertEquals(-101, result);
    }
    ...
    public void whenAppBaseIsChanged() {
        ...
        Mockito.when(openExchangeRatesClient.getHistoricalRates(anyString(), anyString()))
                .thenReturn(this.prevRates);
        int result = exchangeRatesService.getKeyFromTag(this.base);
        assertEquals(0, result);
    }
}
